      ...
      <div className="ls-switcher">
        <div className="show-result">
          <div className="show-1023">
            ...
            >
              <span className="icon icon-filter"></span> Фильтр
            </button>
          </div>
          {/* Collapsible sidebar button */}

          <div className="text">
            Показано <strong>{content?.length}</strong> публикации
          </div>
        </div>
        {/* End show-result */}
        ...
        <div className="sort-by">
          ...
          >
            ...
            <option value="asc">Новизне</option>
            <option value="des">Цене</option>
          </select>
          {/* End select */}
